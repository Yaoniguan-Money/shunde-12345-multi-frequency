...
- Phase 1 只做真实 health probe；typed Gazetteer adapter 与 runtime snapshot 属 Phase 3，尚未冒充完成。

## PostgreSQL / pgvector

- Container：`shunde-12345-postgres-1`
- PostgreSQL：`17.8`
- pgvector extension：`0.8.1`
- Port：`127.0.0.1:5432`
- Alembic revision：`fff93032eb16 (head)`
...
| 2 import | PLANNED | 未实现导入 handler/adapter；未把 Phase 0 审计冒充导入功能 |
| 3 gazetteer | PLANNED | 未实现 snapshot builder、alias index 或 GazetteerApiAdapter |
| 4 AI structured understanding | PLANNED | 本地模型未配置，未运行 LLM |
